declare module '@actions/core' {
  ...
  export function error(message: string | Error, properties?: Record<string, unknown>): void
  export function warning(message: string | Error, properties?: Record<string, unknown>): void
  export function notice(message: string | Error, properties?: Record<string, unknown>): void
  ...
  export function toCommandProperties(annotationProperties: unknown): Record<string, string>
  export function getMultilineInput(name: string, options?: { required?: boolean }): string[]
